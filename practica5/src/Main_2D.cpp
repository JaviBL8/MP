...
int main (void)
{
	...
	PintaMatriz2D_2 (submatriz, fe-fi, ce-ci);
	...
	Matriz2D_2 matriz_una_fila_menos = EliminaFilaMatriz2D_2 (matriz, fils, cols, fila_borrar);

	PintaMatriz2D_2 (matriz_una_fila_menos, fils-1, cols);

	Liberar(matriz_una_fila_menos);
	// ELIMINA COLUMNA 
	...
	Liberar(matriz_una_columna_menos);
	...
	Matriz2D_2 traspuesta_traspuesta = TraspuestaMatriz2D_2 (traspuesta, cols, fils);

	cout << "\nMatriz traspuesta de la traspuesta= "<<endl; 
	PintaMatriz2D_2 (traspuesta_traspuesta, fils, cols);

	Liberar(traspuesta);
	Liberar(traspuesta_traspuesta);
	// INVERSION FILAS
